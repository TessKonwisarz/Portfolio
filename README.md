...
After the data has been cleaned, it is useful to display the data in a table in a way that clearly displays the data collection results. A table will allow give a better idea as how to best plot the data to show the trends in order to answer a research question. 
